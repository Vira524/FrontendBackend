        ...
        <div class="col-md-12">
            <form method="POST" >
                ...
                <select class="form-control" name="kelas">
                    <option value="I" <?php if ($kelas=='TI') {echo "selected";} ?>>TI</option>
                    <option value="II"<?php if ($kelas=='MSN') {echo "selected";} ?>>MSN</option>
                    <option value="III"<?php if ($kelas=='PRTN') {echo "selected";} ?>>PRTN</option>
                </select>
                </div>
